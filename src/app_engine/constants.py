...
TURN_SERVER_OVERRIDE = [
    {
    "urls": [
         "turn:TURN_IP_REPLACE:TURN_PORT_REPLACE?transport=udp",
         "turn:TURN_IP_REPLACE:TURN_PORT_REPLACE?transport=tcp"
    ],
    "username": "SHARED_KEY_REPLACE",
    "credential": "SHARED_KEY_REPLACE"
    }
]
